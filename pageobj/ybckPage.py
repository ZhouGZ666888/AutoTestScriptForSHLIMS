...
class GetSampleCK(BasePage):
    ...
    def samplereceive_ck(self, sql):
        ...
        if not getSampleLimsId:
            ...
            self.sleep(1)
            log.info('实验流程模版切换到Illumina模版类型')
            self.click_by_js('css',Illumina)
            self.sleep(0.5)
    ...
    def unsamplereceive_ck(self, sql):
        ...
        if not getSampleLimsId:
            ...
            self.clicks('css', hstq_ck_keep_project_button)
            self.sleep(0.5)
            log.info("选择【保留】")
            self.click_by_js('xpath', hstq_ck_keep_project_value)
            self.sleep(0.5)
            log.info("选择【上机平台】")
            self.clicks('css', platform)
            self.sleep(0.5)
            log.info("选择【保留】")
            self.click_by_js('xpath', platform_choice)
            self.sleep(0.5)
            log.info("点击保存并下一步")
            ...
            self.sleep(0.5)
            if self.isClickable('css',ckAuditor_box):
    ...
    def libquantmixed_sample_ck(self, sql):
        ...
        if not getSampleLimsId:
            ...
            self.sleep(0.5)
            log.info("点击【上机平台】按钮")
            self.clicks('css', wkdl_ck_platform)
            self.sleep(0.5)
            log.info("选择【Illumina】")
            self.clicks('xpath', wkdl_ck_platform_choice)


            log.info("点击【上机目的】按钮")
            self.clicks('css', wkdl_ck_sequence_goal_button)
            self.sleep(0.5)
            log.info("选择【一般测序】按钮")
            self.clicks('xpath', wkdl_ck_sequence_goal_value)
            self.sleep(0.5)
            log.info("点击【是否保留原项目信息】按钮")
            self.clicks('css', wkdl_ck_keep_project_button)
            self.sleep(0.5)
            log.info("选择【保留】选项")
