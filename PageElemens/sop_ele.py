...
sop_detail_sopname_module_value = ('//*[@class="el-scrollbar__view el-select-dropdown__list"]//descendant::li['
                                   '@class="el-select-dropdown__item" and span[text()="{}"]]')
#详情页，选择操作方式下拉框
...
# 详情页，sop对应模块的任务类型下拉框
sop_detail_sopname_type = (
    '//*[@class="el-form-item el-form-item--medium" and descendant::span[text()="对应任务类型"] ]//div[@class="el-input el-input--medium el-input--suffix"]//input')
...
#详情页，点击新增步骤按钮
sop_detail_add_step=('//*[@class="el-button border_size baseClass-btn-add-stepList el-button--primary el-button--mini"]')
#详情页，点击步骤编号输入框
sop_detail_step_num=(' .SOPversionDetail-sopSteps .vxe-table--body-wrapper tbody td:nth-child(1) input')
#详情页，点击同步步骤编号按钮
sop_detail_add_restep=('//*[@class="el-button border_size baseClass-btn-edit-synchronization el-button--primary el-button--mini"]')
