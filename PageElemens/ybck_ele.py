...
# 点击【是否保留原项目信息】按钮
hstq_ck_keep_project_button = '#pane-extraction  .processFlow > div:nth-child(1) > :nth-child(5)'

# 下拉框选择【保留】选项
hstq_ck_keep_project_value = '//*[@class="el-dropdown-menu__item extraction-original-project1"]'

# 点击【上级平台】按钮
platform = '#pane-extraction  .processFlow > div:nth-child(1) > :nth-child(3)'

# 下拉框选择【非华大】选项
platform_choice = '//*[@class="el-dropdown-menu__item extraction-original-project01"]'
...
# 点击【上机平台】按钮
wkdl_ck_platform = '#pane-libquant .poolingOut > div:nth-child(1) > div:nth-child(1) button:nth-child(1)'

# 选择【Illumina】
wkdl_ck_platform_choice = '//*[@class="el-dropdown-menu__item libquant-original-project01"]'

# 点击【上机目的】按钮
wkdl_ck_sequence_goal_button = '#pane-libquant .poolingOut > div:nth-child(1) > div:nth-child(2) button:nth-child(1)'

# 选择【一般测序】
wkdl_ck_sequence_goal_value = '//body/ul[2]/li[1]'




# 点击【是否保留原项目信息】按钮
wkdl_ck_keep_project_button = '#pane-libquant .poolingOut > div:nth-child(1) > div:nth-child(3) button:nth-child(1)'
